        ...
        {(() => {
          ...
          pages.push(
            <Button
              ...
              className={currentPage === 1 ? "border-brand text-brand" : ""}
              size="sm"
            ...
            if (i !== 1 && i !== totalPages) {
              pages.push(
                <Button
                  ...
                  className={currentPage === i ? "border-brand text-brand" : ""}
                  size="sm"
          ...
          if (totalPages > 1) {
            pages.push(
              <Button
                ...
                className={currentPage === totalPages ? "border-brand text-brand" : ""}
                size="sm"
