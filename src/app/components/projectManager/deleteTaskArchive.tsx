    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px">
        <DialogHeader>
          ...
          <DialogDescription>This action restore this task</DialogDescription>
        </DialogHeader>
        <div className="flex justify-end space-x-3 mt-4">
          <Button
            variant={`outline`}
            className="!bg-white !text-gray-500 !border-[0.5px] !border-gray-500 !hover:bg-red-100 !rounded-lg !px-4 !py-2 flex items-center gap-2"
            onClick={onClose}
          >
            Cancel
          </Button>
