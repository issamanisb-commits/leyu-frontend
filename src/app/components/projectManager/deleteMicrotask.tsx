...
import { useDeleteMicroTask } from "@/lib/hooks/useProject";
...
export function DeleteTask({
  ...
  const deleteTaskMutation = useDeleteMicroTask(task_id);
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px">
        <DialogHeader>
          ...
          <DialogDescription>
            This action cannot be undone. This will delete the  Micro task
          </DialogDescription>
        </DialogHeader>
